...
$sql = "select * from orders_history 
                            ...
                            where books.stores_id = $store and orders_detail.detail_status = 2";
            ...
            <div width="100%" style="margin: 0 25% 0 25%;">
                <div class="d-flex justify-content-center">
                    ...
                    <div class="text-center my-2 fw-semibold fs-6 text-white" style="margin-left:4.5rem;"><a
                            href="history_ordersuccess.php" style="text-decoration: none; color:black;">
                            <div class="text-white">ประวัติการขาย</div>
                        </a></div>
                    <div class="text-center my-2 fw-semibold fs-6 text-white" style="margin-left:4.5rem;"><a
                            href="history_ordercancel.php" style="text-decoration: none; color:black;">
                    ...
                    <tbody>
                        <?php if ($r->detail_status == 2) { ?>
                            ...
                            <td width="80" class="text-center">
                                <?php echo $r->detail_quantity ?> เล่ม
                            </td>
                            <td>
                                <?php echo $r->detail_price ?> บาท
                            </td>
                            <td>
                                <?php echo $amount ?> บาท
                            </td>
                            <td>
                                <?php echo $r->orders_fullname ?>
                            </td>
                            <td width="200">
                                <?php echo $r->orders_address ?>
                            </td>
                            <td>
                                <?php echo $r->orders_phone ?>
                            </td>
                            <td>
                                <?php if ($r->detail_slip != '') { ?>
                            ...
                            <td class="bg bg-danger text-center">
                                <?php if ($r->detail_status == 2) { ?>
                                    <div class="text-white ">ยกเลิกการสั่งซื้อ</div>
                                <?php } ?>
                            </td>
                        <?php } else {
